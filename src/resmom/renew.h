...
#define CRED_DESTROY	    2

#define	CRED_DATA_SIZE	4096
#define	MSG_SIZE	3172

#define KRB525_FALLBACK_LIFETIME    35700
#define KRB525_FALLBACK_TIME	    60
#define KRB525_FALLBACK_RETRY	    30
...
int renew_job_cred(job *pjob); /* az se odebere krb525_fallback muze byt typu void */
