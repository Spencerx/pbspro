...
#define SVR_RENEW_CREDS_TM	5	/* each 5*60 seconds, reschedule the work task and spread renew within the 5*60 seconds */
#define SVR_RENEW_PERIOD_DEFAULT	3600	/* default renew creds 1 hour befor expiration */
#define SVR_RENEW_CACHE_PERIOD_DEFAULT	7200	/* default cred usable 2 hour befor expiration */
...
svr_renew_creds(struct work_task *pwt)
{
	...
	/*
	 * Traverse through the SERVER job list and ...
	 */
